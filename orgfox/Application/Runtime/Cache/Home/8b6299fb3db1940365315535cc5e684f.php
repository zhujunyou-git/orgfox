...
<script src="/Public/js/myindex.js"></script>
  ...
  <div class="container-fluid box">
    ...
    <div class="container marginTop taskhall taskmain">
      <p class="hallnav">你所在的位置：<a href="">首页</a><span>></span><a href="">用户中心</a><span>></span><a href="">我的订单</a>><a href="">订单详情</a></p>
    </div>
     <div class="container taskdelivery">
      <div class="deliverybox1">
        <form action="">
        <h3><span>客户需求</span></h3>
        <div class="delivery2 diat">
          ...
          <h6>需求描述</h6>
          <p><?php echo ($data['demand']); ?></p>
            <?php if(!empty(data['file'][0])): else: ?>
                <?php if(is_array($data['file'])): $i = 0; $__LIST__ = $data['file'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="<?php echo ($vo); ?>">查看附件</a><?php endforeach; endif; else: echo "" ;endif; endif; ?>
        </div>
        <div class="deliverybutton">
            <a href="<?php echo U('Serve/livery?id='.$data['id']);?>"  class="deliverysubmit">内容交付</a>
<!--          <a href="./">返回</a>-->
        </div>
         </form>
      </div>
