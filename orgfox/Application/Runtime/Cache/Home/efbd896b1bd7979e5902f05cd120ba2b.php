...
<script src="/Public/js/myindex.js"></script>
    ...
    <div class="container paybox2">
        <h3>选择支付方式</h3>
        <div class="payline">
          <p>支付金额：<b>￥<?php echo ($order_shop['money']); ?></b></p>
          <div class="paymain">
            <span class="cur">余额支付</span>
            <span>第三方支付</span>
            <div class="paymoney">
              <form action="<?php echo u('pay?id='.$order_shop['id']);?>" method="post">
                <p>你的账户可用余额：<b>￥<?php echo ($moeny); ?></b></p>
                <p>请输入支付密码：<input type="text" name="paypassword"></p>
                <div class="paybutton">
                  <input type="hidden" name="money" value="<?php echo ($order_shop['money']); ?>">
