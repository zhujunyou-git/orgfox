...
<script src="/Public/js/myindex.js"></script>
  ...
  <div class="container-fluid box">
    ...
    <div class="container marginTop taskhall taskmain">
      <p class="hallnav">你所在的位置：<a href="">首页</a><span>></span><a href="">用户中心</a><span>></span><a href="">我的订单</a><a href="">内容交付</a></p>
    </div>
     <div class="container taskdelivery">
      <div class="deliverybox1">
        <form action="" id="formti" method="post" enctype="multipart/form-data">
        <h3><span>内容交付</span></h3>
        <div class="delivery2">
          <textarea class="form-control" rows="10" name="describe"></textarea>
          <p>描述不能为空</p>
          <div class="form-group">
            <input type="file" id="exampleInputFile" name="delivery_file[]">
            <input type="file" id="exampleInputFile" name="delivery_file[]">
            <input type="file" id="exampleInputFile" name="delivery_file[]">
          ...
          <div class="checkbox">
            <label>
              <input type="checkbox" checked="checked" >我已阅读并同意《企狐文件交稿协议》
            </label>
          </div>
        </div>
        <div class="deliverybutton">
          <input type="button" value="提交" class="deliverysubmit"/>
          <a href="">返回</a>
        </div>
         </form>
      </div>
  ...
  <script>
    ...
    var t=$(".checkbox input").prop('checked');
      if(t==true){
       $("#formti").submit();
      }else{
        alert("未同意该协议！");
