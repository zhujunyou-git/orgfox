...
<script src="/Public/js/myindex.js"></script>
    ...
    <div class="container marginTop taskhall">
      <p class="hallnav">你所在的位置：<a href="">首页</a><span>></span><a href="">企业导航</a></p>
      <div class="halllist">
          <ul>
              <li>
    ...
    <div class="container taskhallone serveP">
      ...
      <div class="pull-left hallright">
           ...
           <div class="hallcenter">
               <ul>
                   <?php if(is_array($shop)): $i = 0; $__LIST__ = $shop;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                       <div>
                           <span class="servebox pull-left autoimg" style="background-image: url(<?php echo ($vo['head']); ?>);width: 60px;height:60px;"></span>
                           <h3><?php echo ($vo['shopname']); ?></h3>
                           <p>服务范围<?php echo ($vo['indus_id']); ?>-<?php echo ($vo['indus_pid']); ?>-<?php echo ($vo['indus_tid']); ?></p>
                           <p>成交量:<?php echo ($vo['total']); ?></p>
                           <p>地址:<?php echo ($vo['pro']); ?>-<?php echo ($vo['city']); ?></p>
                           <p class="ljbutton"><a href="">进入店铺</a><a href="">联系我</a></p>
                       </div>
...
<script>
    $(function(){
        ...
        $('.one').click(function(){
            ...
            $.post("<?php echo U('Service/two_server');?>",{indus_id:id},function(msg){
        ...
        $(".sedtwo").delegate("a","click",function(){
            ...
            $(".childrens").val(id);
            $(".twoul,.therep").html("");
            $.post("<?php echo U('Service/three_server');?>",{indus_pid:id},function(msg){
        ...
        $(".therep").delegate("a","click",function(){
            ...
            $(".minchildrens").val(id);
            $(".twoul").html("");
            $.post("<?php echo U('Service/server');?>",{indus_tid:id},function(msg){
