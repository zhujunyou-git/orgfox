    ...
    <div class="container marginTop taskhall taskmain">
     ...
     <div class="container taskdelivery">
      ...
      <div class="deliverybox1">
        <form action="<?php echo U('task/taskdeliveryadd');?>" id="form1" method="post" enctype="multipart/form-data">
        <h3><span>交付任务</span></h3>
        <div class="delivery2">
        ...
        <div class="deliverybutton">
          ...
          <input type="hidden" name="task_pid" value="<?php echo ($data['task_pid']); ?>">
