				...
				<div class="moneycheck">
						<div class="moneyblock">
							...
							<div class="cur">
								...
								<?php if(is_array($bankList)): $i = 0; $__LIST__ = $bankList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="row1 moneyrow6">
									<div class="row-left">
										<div class="form-group">
				                           <input type="checkbox" name="bank_id[]" class="numberim" value="<?php echo ($vo["bank_id"]); ?>"><?php echo ($vo["bank_id"]); ?>
										</div>
									</div>
									<div class="row-left">
										<div class="form-group">
									...
									<div class="row-left">
										<div class="form-group">
											<?php if($vo["bank_status"] == 1 ): ?>未通过
												<?php else: ?>
												已通过<?php endif; ?>
				                           <a href="<?php echo U('Authentication/wse',['bank_id'=>$vo['bank_id']]);?>" class="browse">浏览</a>
											<?php if($vo["bank_status"] == 1 ): ?><a  href="<?php echo U('Authentication/bank',['bank_id'=>$vo['bank_id']]);?>">确认审核</a><?php endif; ?>
										</div>
									</div>
							...
							<div class="row1 myfixed myfixed1">
								<div class="form-group">
									...
									<h3 >确定通过审核？<a href="javascript:void(0);">x</a></h3>
										<a  href="<?php echo U('Authentication/bank',['bank_id'=>$vo['bank_id']]);?>">确认审核</a>
									</form>
								</div>
							</div>
							...
							<div class="row1 myfixed myfixed6">
								<div class="form-group">
									<form action="<?php echo U('Authentication/bankdel');?>" method="post">
