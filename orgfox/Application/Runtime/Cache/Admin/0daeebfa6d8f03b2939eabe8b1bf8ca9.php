                                ...
                                <form action="">
                                    ...
                                    <?php if(is_array($pid)): foreach($pid as $key=>$vo): ?><div class="myparents">
                                            <div class="row1 moneyrow5">
                                                <div class="row-left">
                                                    <div class="form-group">
                                                        <input type="button" class="form-input-txt" name="nunber"
                                                               value="<?php echo ($vo["industry_id"]); ?>">
                                                    </div>
                                                </div>
                                                <div class="row-left">
                                                    <div class="form-group">
                                                ...
                                                <div class="row-left">
                                                    <div class="form-group">
                                                        ...
                                                        <a href="<?php echo U('industry/del?industry_id='.$vo['industry_id']);?>"
                                                           data-id="<?php echo ($vo['industry_id']); ?>" class="myidbox">删除</a>
                                                    ...
                                                    <div class="row1 moneyrow5">
                                                        ...
                                                        <div class="row-left">
                                                            <div class="form-group">
                                                                ...
                                                                <a href="<?php echo U('industry/del?industry_id='.$li['industry_id']);?>" data-id="<?php echo ($li['industry_id']); ?>" class="myidbox">删除</a>
                                                                <input type="button" class="addchilren" value="增加子类"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <?php if(is_array($li['list'])): foreach($li['list'] as $key=>$i): ?><div class="mychildren">
                                                        <div class="row1 moneyrow5">
                                                            <div class="row-left">
                                                                <div class="form-group">
                                                                    <input type="button" class="form-input-txt"
                                                                           name="nunber" value="<?php echo ($i['industry_id']); ?>">
                                                                </div>
                                                            </div>
                                                            <div class="row-left">
                                                                <div class="form-group">
                                                                    <span><?php echo ($i['industry_name']); ?></span>
                                                                </div>
                                                            </div>
                                                            <div class="row-left">
                                                                <div class="form-group">
                                                                    <?php echo (date("Y-m-d",$i['time'])); ?>
                                                                </div>
                                                            </div>
                                                            <div class="row-left">
                                                                <div class="form-group">
                                                                    <a href="<?php echo U('edit?industry_id='.$i['industry_id']);?>">编辑</a>
                                                                    <a href="<?php echo U('industry/del?industry_id='.$i['industry_id']);?>">删除</a>
                                                                </div>
                                                            </div>
                                                        </div>
                            ...
                            <div class="row1 myfixed myfixed3">
                                <div class="form-group">
                                    <form action="<?php echo U('industry/indus');?>" method="post">
                                        ...
                                        <input type="text" name="industry_name" class="form-input-txt">
                                        <input type="submit" class="buttonbox sunmit" value="提交">
                                        <input type="hidden" value="" name="industry_pid" class="myhiddens"/>
                                    </form>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        $(function () {
            $(".seelook").click(function () {
                ...
                if (!t.hasClass("cur")) {
                    t.addClass("cur");
                    t.parent().parent().parent().parent().css("height", "auto");
                    t.val("收起子类");
                } else {
                    t.removeClass("cur");
                    t.parent().parent().parent().parent().css("height", "53px");
                    t.val("查看子类");
                }
            });
            ...
            $(".myfixed h3 a").click(function () {
                $(".myfixed2,.myfixed3").css("display", "none");
            });
        });
