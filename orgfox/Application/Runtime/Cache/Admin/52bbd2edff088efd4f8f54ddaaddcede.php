	...
	<div class="container">
		<div class="myboxdiv">
			...
			<div class="public-content">
				...
				<form action="<?php echo U('column/add');?>" method="post" enctype="multipart/form-data">
				<div class="row1">
					<div class="row-left">
						<div class="form-group">
							...
							<select class="form-input-txt" name="upid">
								...
								<?php if(is_array($upid)): $i = 0; $__LIST__ = $upid;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" ><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
							</select>
						</div>
					</div>
				</div>
					...
					<div class="row-left">
						<div class="form-group">
							<label for="">行业名称</label>
								<input type="text" class="form-input-txt" name="name" >
						</div>
					</div>
				</div>
				<div class="row1">
