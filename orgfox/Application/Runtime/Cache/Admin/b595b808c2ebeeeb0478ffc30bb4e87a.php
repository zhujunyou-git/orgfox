...
<div class="public-header-warrp">
	<div class="public-header">
		<div class="content">
			<div class="public-header-logo"><a href=""><i>LOGO</i><h3>企狐</h3></a></div>
			...
			<ul>
				<li class="ifame-item logo">
					<div class="item-warrp">
						<a href="#"><i>LOGO</i>
							<h3 class="logo-title">企狐</h3>
							<p class="logo-des">创建于 2016/10/21 22:22:47</p>
						</a>
					</div>
				</li>
		...
		<div class="public-ifame-leftnav">
			...
			<ul class="left-nav-list">
				...
				<li class="public-ifame-item">
					...
					<div class="ifame-item-sub">
						<ul>
							<li><a href="Information/article_manage.html" target="content">列表管理</a>|<a href="Information/article_add.html" target="content">添加</a></li>
							<li><a href="Information/cate_manage.html" target="content">分类管理</a></li>
						</ul>
					</div>
				</li>
				<li class="public-ifame-item">
					...
					<div class="ifame-item-sub">
						<ul>
							<li><a href="Tourism/lytc_manage.html" target="content">信息列表</a>|<a href="#" target="content">添加</a></li>
							<li><a href="#" target="content">分类管理</a></li>
							<li><a href="#" target="content">分类管理</a></li>
							<li><a href="Tourism/listbanner.html" target="content">列表页轮播管理</a></li>
							<li><a href="Tourism/listbanner.html" target="content">分类轮播管理</a></li>
							<li><a href="Tourism/listbanner.html" target="content">旅游预订管理</a></li>
						</ul>
					</div>
				</li>
				<li class="public-ifame-item">
				...
				<li class="public-ifame-item">
					...
					<div class="ifame-item-sub">
						<ul>
							<li><a href="advertisement/ading.html" target="content">广告列表</a></li>
							<li><a href="advertisement/advertising.html" target="content">广告位</a></li>
						</ul>
					</div>
				</li>
				<li class="public-ifame-item">
				...
				<li class="public-ifame-item">
					<a href="javascript:;">悬赏</a>
					<div class="ifame-item-sub">
						<ul>
							<li><a href="<?php echo U('mission/reward');?>" target="content">mission</a></li>
							<li><a href="<?php echo U('mission/configure');?>" target="content">任务配置</a></li>
						</ul>
					</div>
				</li>
				<li class="public-ifame-item">
					...
					<div class="ifame-item-sub">
						<ul>
							<li><a href=" Finance/moneyone.html" target="content">财务概况</a></li>
							<li><a href=" Finance/payments.html" target="content">网站收支</a></li>
							<li><a href=" Finance/water.html" target="content">用户流水</a></li>
							<li><a href=" Finance/examine.html" target="content">充值审核</a></li>
							<li><a href=" Finance/withdrawals.html" target="content">提现审核</a></li>
							<li><a href=" Finance/manual.html" target="content">手动充值</a></li>
						</ul>
					</div>
				</li>
				<li class="public-ifame-item">
					...
					<div class="ifame-item-sub">
						<ul>
							<li><a href="<?php echo U('configuration/region');?>" target="content">地区管理</a></li>
							<li><a href="<?php echo U('configuration/pay');?>" target="content">支付接口</a></li>
							<li><a href="<?php echo U('configuration/industry');?>" target="content">行业管理</a></li>
							<li><a href="<?php echo U('configuration/column');?>" target="content">栏目列表</a></li>
						</ul>
					</div>
				</li>
				<li class="public-ifame-item">
					...
					<div class="ifame-item-sub">
						<ul>
							<li><a href="<?php echo U('Authentication/alipay');?>" target="content">支付宝认证</a></li>
							<li><a href="<?php echo U('Authentication/bank');?>" target="content">银行认证</a></li>
							<li><a href="<?php echo U('Authentication/phone');?>" target="content">手机认证</a></li>
							<li><a href="<?php echo U('Authentication/realname');?>" target="content">实名认证</a></li>
						</ul>
					</div>
				</li>
			</ul>
